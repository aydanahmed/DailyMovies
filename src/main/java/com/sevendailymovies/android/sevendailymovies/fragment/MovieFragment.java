...
import com.sevendailymovies.android.sevendailymovies.service.CheckForNewDataService;
import com.sevendailymovies.android.sevendailymovies.R;
import com.sevendailymovies.android.sevendailymovies.adapter.TopMovieAdapter;
...
public class MovieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (movies.size() == 0) {
            ...
            task.execute("aHR0cDovL2RibW92aWVzLm5ld3MvdG9wMTAucGhw");
        }
